...
<head>
  ...
  <!-- Primary Meta Tags -->
  <title>${safeTitle} | Jeff Hill Realty</title>
  ...
  <meta property="og:site_name" content="Jeff Hill Realty">
  <meta property="og:locale" content="en_US">
  <meta property="article:author" content="${sanitize(post.author) || 'Jeff Hill'}">
